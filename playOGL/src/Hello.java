...
public class Hello implements GLEventListener {
	...
	public void display(GLAutoDrawable canvas) {
		...
		gl.glVertexAttribPointer(0, 3, GL.GL_FLOAT, false, 6 * Float.BYTES, 0);// first 0 is the location in shader
		gl.glVertexAttribPointer(1, 3, GL.GL_FLOAT, false, 6 * Float.BYTES, 3 * Float.BYTES);// first 0 is the location in shader
